...
echo ""
echo "  $PI_IP  pulse.test"
echo ""
echo "Access PULSE:"
echo "  http://pulse.test:30080     (HTTP)"
echo "  https://pulse.test:30443    (HTTPS — accept the self-signed cert warning once)"
echo ""
echo "Everything else (MFE remotes, APIs) is proxied through pulse-shell."
echo ""
