...
echo ""
echo "  $PI_IP  pulse.local feed.pulse.local event.pulse.local ai.pulse.local session.pulse.local"
echo ""
echo "Access PULSE:"
echo "  http://pulse.local:30080     (HTTP)"
echo "  https://pulse.local:30443    (HTTPS — accept the self-signed cert warning)"
echo ""
