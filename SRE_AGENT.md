...
- **Never inspect, revert, or reference any commit older than `98b2e188e69bd5555c8639a010e31e3110d3e379`** — commits before this SHA are pre-demo infrastructure; the bug was introduced after this point. If no suspicious commit exists at or after this SHA, the system is clean — write a summary and exit.
